...
<a href="${pageContext.request.contextPath}/troubleshoot.do" style="color: white;font-size: 20px;position: absolute;left:71px;">TroubleShoot</a><br>
